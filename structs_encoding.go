...
// Hash: 8b2d704b64732b7504f42c5ac50628afe3e11efb51611389b0873eafd22fde81
// Version: 0.1.3
package consensus
...
func (l *LightClientBootstrap) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'CurrentSyncCommitteeBranch'
	l.CurrentSyncCommitteeBranch = make([][32]byte, 5)
	for ii := 0; ii < 5; ii++ {
...
func (l *LightClientFinalityUpdate) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'FinalityBranch'
	l.FinalityBranch = make([][32]byte, 6)
	for ii := 0; ii < 6; ii++ {
...
func (l *LightClientUpdate) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'NextSyncCommitteeBranch'
	l.NextSyncCommitteeBranch = make([][32]byte, 5)
	for ii := 0; ii < 5; ii++ {
...
func (l *LightClientHeaderCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if l.Execution == nil {
		l.Execution = new(ExecutionPayloadHeaderCapella)
	}
...
func (l *LightClientHeaderCapella) UnmarshalSSZ(buf []byte) error {
	...
	for ii := 0; ii < 4; ii++ {
		copy(l.ExecutionBranch[ii][:], buf[116:244][ii*32:(ii+1)*32])
	}
...
func (l *LightClientHeaderCapella) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientHeaderCapella object
func (l *LightClientHeaderCapella) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}
...
func (l *LightClientBootstrapCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'CurrentSyncCommitteeBranch'
	if size := len(l.CurrentSyncCommitteeBranch); size != 5 {
		err = ssz.ErrVectorLengthFn("LightClientBootstrapCapella.CurrentSyncCommitteeBranch", size, 5)
		return
	}
	for ii := 0; ii < 5; ii++ {
		dst = append(dst, l.CurrentSyncCommitteeBranch[ii][:]...)
...
func (l *LightClientBootstrapCapella) UnmarshalSSZ(buf []byte) error {
	...
	l.CurrentSyncCommitteeBranch = make([][32]byte, 5)
	for ii := 0; ii < 5; ii++ {
		copy(l.CurrentSyncCommitteeBranch[ii][:], buf[24628:24788][ii*32:(ii+1)*32])
	}
...
func (l *LightClientBootstrapCapella) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientBootstrapCapella object
func (l *LightClientBootstrapCapella) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}
...
func (l *LightClientFinalityUpdateCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'FinalityBranch'
	if size := len(l.FinalityBranch); size != 6 {
		err = ssz.ErrVectorLengthFn("LightClientFinalityUpdateCapella.FinalityBranch", size, 6)
		return
	}
	for ii := 0; ii < 6; ii++ {
		dst = append(dst, l.FinalityBranch[ii][:]...)
...
func (l *LightClientFinalityUpdateCapella) UnmarshalSSZ(buf []byte) error {
	...
	l.FinalityBranch = make([][32]byte, 6)
	for ii := 0; ii < 6; ii++ {
		copy(l.FinalityBranch[ii][:], buf[8:200][ii*32:(ii+1)*32])
	}
	...
	// Field (4) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint64(buf[360:368])
...
func (l *LightClientFinalityUpdateCapella) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientFinalityUpdateCapella object
func (l *LightClientFinalityUpdateCapella) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}
...
func (l *LightClientOptimisticUpdateCapella) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint64(buf[164:172])
...
func (l *LightClientOptimisticUpdateCapella) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientOptimisticUpdateCapella object
func (l *LightClientOptimisticUpdateCapella) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}
...
func (l *LightClientUpdateCapella) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'NextSyncCommitteeBranch'
	if size := len(l.NextSyncCommitteeBranch); size != 5 {
		err = ssz.ErrVectorLengthFn("LightClientUpdateCapella.NextSyncCommitteeBranch", size, 5)
		return
	}
	for ii := 0; ii < 5; ii++ {
		dst = append(dst, l.NextSyncCommitteeBranch[ii][:]...)
	...
	// Field (4) 'FinalityBranch'
	if size := len(l.FinalityBranch); size != 6 {
		err = ssz.ErrVectorLengthFn("LightClientUpdateCapella.FinalityBranch", size, 6)
		return
	}
	for ii := 0; ii < 6; ii++ {
		dst = append(dst, l.FinalityBranch[ii][:]...)
...
func (l *LightClientUpdateCapella) UnmarshalSSZ(buf []byte) error {
	...
	l.NextSyncCommitteeBranch = make([][32]byte, 5)
	for ii := 0; ii < 5; ii++ {
		copy(l.NextSyncCommitteeBranch[ii][:], buf[24628:24788][ii*32:(ii+1)*32])
	}
	...
	l.FinalityBranch = make([][32]byte, 6)
	for ii := 0; ii < 6; ii++ {
		copy(l.FinalityBranch[ii][:], buf[24792:24984][ii*32:(ii+1)*32])
	}
	...
	// Field (6) 'SignatureSlot'
	l.SignatureSlot = ssz.UnmarshallUint64(buf[25144:25152])
...
func (l *LightClientUpdateCapella) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientUpdateCapella object
func (l *LightClientUpdateCapella) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}

// MarshalSSZ ssz marshals the ExecutionPayloadHeaderDencun object
func (e *ExecutionPayloadHeaderDencun) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionPayloadHeaderDencun object to a target array
func (e *ExecutionPayloadHeaderDencun) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(568)
	...
	// Field (10) 'ExtraData'
	if size := len(e.ExtraData); size > 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderDencun.ExtraData", size, 32)
		return
	}
	dst = append(dst, e.ExtraData...)
...
// UnmarshalSSZ ssz unmarshals the ExecutionPayloadHeaderDencun object
func (e *ExecutionPayloadHeaderDencun) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 568 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionPayloadHeaderDencun object
func (e *ExecutionPayloadHeaderDencun) SizeSSZ() (size int) {
	size = 568
...
// HashTreeRoot ssz hashes the ExecutionPayloadHeaderDencun object
func (e *ExecutionPayloadHeaderDencun) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionPayloadHeaderDencun object with a hasher
func (e *ExecutionPayloadHeaderDencun) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the ExecutionPayloadHeaderDencun object
func (e *ExecutionPayloadHeaderDencun) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(e)
}

// MarshalSSZ ssz marshals the LightClientHeaderDencun object
func (l *LightClientHeaderDencun) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientHeaderDencun object to a target array
func (l *LightClientHeaderDencun) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(244)
	...
	dst = ssz.WriteOffset(dst, offset)
	if l.Execution == nil {
		l.Execution = new(ExecutionPayloadHeaderDencun)
	}
	offset += l.Execution.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the LightClientHeaderDencun object
func (l *LightClientHeaderDencun) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 244 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientHeaderDencun object
func (l *LightClientHeaderDencun) SizeSSZ() (size int) {
	size = 244
...
// HashTreeRoot ssz hashes the LightClientHeaderDencun object
func (l *LightClientHeaderDencun) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientHeaderDencun object with a hasher
func (l *LightClientHeaderDencun) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientHeaderDencun object
func (l *LightClientHeaderDencun) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}

// MarshalSSZ ssz marshals the LightClientBootstrapDencun object
func (l *LightClientBootstrapDencun) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientBootstrapDencun object to a target array
func (l *LightClientBootstrapDencun) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(24788)
	...
	dst = ssz.WriteOffset(dst, offset)
	if l.Header == nil {
		l.Header = new(LightClientHeaderDencun)
	}
	offset += l.Header.SizeSSZ()
	...
	// Field (2) 'CurrentSyncCommitteeBranch'
	if size := len(l.CurrentSyncCommitteeBranch); size != 5 {
		err = ssz.ErrVectorLengthFn("LightClientBootstrapDencun.CurrentSyncCommitteeBranch", size, 5)
		return
	}
	for ii := 0; ii < 5; ii++ {
		dst = append(dst, l.CurrentSyncCommitteeBranch[ii][:]...)
...
// UnmarshalSSZ ssz unmarshals the LightClientBootstrapDencun object
func (l *LightClientBootstrapDencun) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 24788 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientBootstrapDencun object
func (l *LightClientBootstrapDencun) SizeSSZ() (size int) {
	size = 24788
...
// HashTreeRoot ssz hashes the LightClientBootstrapDencun object
func (l *LightClientBootstrapDencun) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientBootstrapDencun object with a hasher
func (l *LightClientBootstrapDencun) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientBootstrapDencun object
func (l *LightClientBootstrapDencun) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}

// MarshalSSZ ssz marshals the LightClientOptimisticUpdateDencun object
func (l *LightClientOptimisticUpdateDencun) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientOptimisticUpdateDencun object to a target array
func (l *LightClientOptimisticUpdateDencun) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(172)
	...
	dst = ssz.WriteOffset(dst, offset)
	if l.AttestedHeader == nil {
		l.AttestedHeader = new(LightClientHeaderDencun)
	}
	offset += l.AttestedHeader.SizeSSZ()
...
// UnmarshalSSZ ssz unmarshals the LightClientOptimisticUpdateDencun object
func (l *LightClientOptimisticUpdateDencun) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 172 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientOptimisticUpdateDencun object
func (l *LightClientOptimisticUpdateDencun) SizeSSZ() (size int) {
	size = 172
...
// HashTreeRoot ssz hashes the LightClientOptimisticUpdateDencun object
func (l *LightClientOptimisticUpdateDencun) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientOptimisticUpdateDencun object with a hasher
func (l *LightClientOptimisticUpdateDencun) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientOptimisticUpdateDencun object
func (l *LightClientOptimisticUpdateDencun) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}

// MarshalSSZ ssz marshals the LightClientFinalityUpdateDencun object
func (l *LightClientFinalityUpdateDencun) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientFinalityUpdateDencun object to a target array
func (l *LightClientFinalityUpdateDencun) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(368)
	...
	dst = ssz.WriteOffset(dst, offset)
	if l.FinalizedHeader == nil {
		l.FinalizedHeader = new(LightClientHeaderDencun)
	}
	offset += l.FinalizedHeader.SizeSSZ()

	// Field (2) 'FinalityBranch'
	if size := len(l.FinalityBranch); size != 6 {
		err = ssz.ErrVectorLengthFn("LightClientFinalityUpdateDencun.FinalityBranch", size, 6)
		return
	}
	for ii := 0; ii < 6; ii++ {
		dst = append(dst, l.FinalityBranch[ii][:]...)
...
// UnmarshalSSZ ssz unmarshals the LightClientFinalityUpdateDencun object
func (l *LightClientFinalityUpdateDencun) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 368 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientFinalityUpdateDencun object
func (l *LightClientFinalityUpdateDencun) SizeSSZ() (size int) {
	size = 368
...
// HashTreeRoot ssz hashes the LightClientFinalityUpdateDencun object
func (l *LightClientFinalityUpdateDencun) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientFinalityUpdateDencun object with a hasher
func (l *LightClientFinalityUpdateDencun) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the LightClientFinalityUpdateDencun object
func (l *LightClientFinalityUpdateDencun) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}

// MarshalSSZ ssz marshals the LightClientUpdateDencun object
func (l *LightClientUpdateDencun) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(l)
}

// MarshalSSZTo ssz marshals the LightClientUpdateDencun object to a target array
func (l *LightClientUpdateDencun) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(25168)
	...
	// Field (2) 'NextSyncCommitteeBranch'
	if size := len(l.NextSyncCommitteeBranch); size != 5 {
		err = ssz.ErrVectorLengthFn("LightClientUpdateDencun.NextSyncCommitteeBranch", size, 5)
		return
	}
	for ii := 0; ii < 5; ii++ {
		dst = append(dst, l.NextSyncCommitteeBranch[ii][:]...)
	...
	// Field (4) 'FinalityBranch'
	if size := len(l.FinalityBranch); size != 6 {
		err = ssz.ErrVectorLengthFn("LightClientUpdateDencun.FinalityBranch", size, 6)
		return
	}
	for ii := 0; ii < 6; ii++ {
		dst = append(dst, l.FinalityBranch[ii][:]...)
	...
	// Field (7) 'BlobGasUsed'
	dst = ssz.MarshalUint64(dst, l.BlobGasUsed)

	// Field (8) 'ExcessBlobGas'
	dst = ssz.MarshalUint64(dst, l.ExcessBlobGas)
...
// UnmarshalSSZ ssz unmarshals the LightClientUpdateDencun object
func (l *LightClientUpdateDencun) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 25168 {
		return ssz.ErrSize
	...
	// Field (7) 'BlobGasUsed'
	l.BlobGasUsed = ssz.UnmarshallUint64(buf[25152:25160])

	// Field (8) 'ExcessBlobGas'
	l.ExcessBlobGas = ssz.UnmarshallUint64(buf[25160:25168])
...
// SizeSSZ returns the ssz encoded size in bytes for the LightClientUpdateDencun object
func (l *LightClientUpdateDencun) SizeSSZ() (size int) {
	size = 25168
...
// HashTreeRoot ssz hashes the LightClientUpdateDencun object
func (l *LightClientUpdateDencun) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(l)
}

// HashTreeRootWith ssz hashes the LightClientUpdateDencun object with a hasher
func (l *LightClientUpdateDencun) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
	...
	// Field (7) 'BlobGasUsed'
	hh.PutUint64(l.BlobGasUsed)

	// Field (8) 'ExcessBlobGas'
	hh.PutUint64(l.ExcessBlobGas)

	hh.Merkleize(indx)
	return
}

// GetTree ssz hashes the LightClientUpdateDencun object
func (l *LightClientUpdateDencun) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(l)
}
